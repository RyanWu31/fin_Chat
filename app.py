...
class Cantai(LLM):
    ...
    def _call(self, prompt: str, stop: Optional[List[str]] = None,
        ...
        system_prompt = """你是一名人工智能助理，名叫 灿态.
...
def load_chain():
    ...
    # llm = InternLM_LLM(model_path="/home/dell/.cache/modelscope/hub/ZhipuAI/chatglm3-6b")
    llm = Cantai(model_path="/home/dell/.cache/modelscope/hub/ZhipuAI/chatglm3-6b-32k")
